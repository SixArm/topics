...
- [Ralph loop](topics/ralph-loop)
- [Dark factory](topics/dark-factory)
- [Model Context Protocol (MCP)](topics/model-context-protocol)

## [AI LLM tokens](topics/ai-llm-tokens)

- [AI context window](topics/ai-context-window)
- [AI compaction](topics/aI-compaction)
- [Retrieval augmented generation (RAG)](topics/retrieval-augmented-generation)
- [Direct preference optimization (DPO)](topics/direct-preference-optimization)
