...
/**
 * Quotation represents a digital health quotation.
 */
class Quotation {
  constructor(options) {
  ...
  getSummary() {
    return {
      ...
      preview:
        this.text.substring(0, 50) + (this.text.length > 50 ? "..." : ""),
    };
  }
}

/**
 * QuotationCollection manages digital health quotations.
 */
class QuotationCollection {
  ...
  /**
   * Initializes with common digital health quotations
   */
  initializeCollection() {
    this.quotations = [
      ...
      new Quotation({
        text: "The first rule of digital health: don't automate chaos.",
        author: "Test Automation Wisdom",
        theme: "prerequisites",
